...
export default function Products() {
  ...
  // Fetching recent products using React Query
  ...
  return (
    <>
      <form className="w-full px-14 sm:w-3/4 md:1/2 lg:px-20 mx-auto mt-10">
      ...
      <div className="row py-2 dark:bg-slate-900 px-10 ">
